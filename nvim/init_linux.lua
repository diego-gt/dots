-- source config https://github.com/nvim-lua/kickstart.nvim
-- adapted for use by diego
--
--
-- Install packer
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'c', 'cpp', 'cmake', 'markdown', 'markdown_inline', 'html', 'json', 'make', 'lua', 'javascript', 'tsx', 'typescript', 'rust', 'toml', 'go', 'python' },
...
local servers = { 'rust_analyzer','clangd', 'pyright', 'tsserver', 'sumneko_lua' }
